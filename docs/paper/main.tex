...
\begin{itemize}
    \item \textbf{P-only} (enhanced): 10/10 runs converged (100\%), with a mean final deviation of 0.020.
    \item \textbf{PID} (enhanced): 9/9 valid runs converged (100\%), with a mean final deviation of 0.025.
    \item \textbf{LLM+BO}: 4/9 valid runs converged (44\%), with a mean final deviation of 0.00033 on converged blueprints.
\end{itemize}

The gain scheduling and dead-band enhancements dramatically improved the classical baselines: convergence rates increased from approximately 67\% (prior fixed-gain implementation) to 100\%.
The P-only controller, in particular, benefits from the gain scheduling's automatic adaptation to the rod worth gradient, achieving consistent convergence across all ten blueprints within 1--2 steps.

Where the LLM+BO controller converged, it achieved remarkably low deviations: 0.00020 (PWR-LE), 0.00024 (PWR-LT), and 0.00049 (PWR-HT), approaching the Monte Carlo statistical uncertainty ($\sigma_k \approx 0.001$).
However, the LLM controller experienced execution failures on 6 of 10 blueprints due to LLM inference errors at step~0, highlighting a reliability gap compared to the deterministic classical controllers.
...
\toprule
& \multicolumn{3}{c}{\textbf{LLM+BO}} & \multicolumn{3}{c}{\textbf{PID} ($K_p\!=\!40$, sched.)} & \multicolumn{3}{c}{\textbf{P-only} ($K_p\!=\!40$, sched.)} \\
\cmidrule(lr){2-4} \cmidrule(lr){5-7} \cmidrule(lr){8-10}
Blueprint & Conv. & Dev. & Step & Conv. & Dev. & Step & Conv. & Dev. & Step \\
\midrule
PWR-STD & \checkmark & \textbf{0.0020} & 1 & \checkmark & 0.0404 & 1 & \checkmark & 0.0152 & 1 \\
PWR-HE  & ---        & ---              & --- & \checkmark & 0.0234 & 1 & \checkmark & 0.0421 & 1 \\
PWR-LE  & \checkmark & \textbf{0.0002} & 1 & \checkmark & 0.0048 & 1 & \checkmark & 0.0103 & 1 \\
PWR-HT  & \checkmark & \textbf{0.0005} & 1 & \checkmark & 0.0370 & 1 & \checkmark & 0.0111 & 1 \\
PWR-LT  & \checkmark & \textbf{0.0002} & 0 & \checkmark & 0.0216 & 2 & \checkmark & 0.0254 & 1 \\
PWR-TP  & ---        & ---              & --- & \checkmark & 0.0316 & 2 & \checkmark & 0.0070 & 1 \\
PWR-WP  & ---        & ---              & --- & \checkmark & 0.0224 & 1 & \checkmark & 0.0309 & 1 \\
PWR-LF  & ---        & ---              & --- & \checkmark & 0.0318 & 2 & \checkmark & 0.0102 & 1 \\
PWR-MID & ---        & ---              & --- & \checkmark & 0.0230 & 1 & \checkmark & 0.0265 & 1 \\
PWR-INS & ---        & ---              & --- & \checkmark & 0.0165 & 1 & \checkmark & 0.0237 & 1 \\
\midrule
\textbf{Rate} & \multicolumn{3}{c}{4/4 (100\%)} & \multicolumn{3}{c}{9/9 (100\%)} & \multicolumn{3}{c}{10/10 (100\%)} \\
\textbf{Avg.\ Dev.} & \multicolumn{3}{c}{\textbf{0.00074}} & \multicolumn{3}{c}{0.0250} & \multicolumn{3}{c}{0.0202} \\
\bottomrule
\end{tabular}
\end{table*}
...
We have demonstrated a comprehensive benchmark of LLM-guided Bayesian optimization against well-tuned classical controllers for nuclear reactor control rod positioning across ten PWR pin-cell configurations.
The enhanced classical baselines---incorporating gain scheduling, dead-band suppression, and continuous rod positioning---achieve 100\% convergence rates, a dramatic improvement over fixed-gain implementations.
Where the LLM+BO controller successfully executes, it achieves $k_\text{eff}$ deviations approximately 30$\times$ smaller than the classical baselines (0.00074 vs.\ 0.020--0.025), though at the cost of reduced reliability (4/10 vs.\ 10/10 successful convergences).
